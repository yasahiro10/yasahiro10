...
Experienced AI Engineer specializing in Computer Vision, NLP, and Large Language Models, with strong expertise in MLOps and data engineering. Proven track record in data valorization,
analysis, and pipeline engineering from raw data to production deployment. Demonstrated success in implementing end-to-end AI solutions with particular focus on healthcare and industrial
applications, emphasizing robust data management practices and scalable deployment strategies.
